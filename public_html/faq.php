...
<div class="row">
	...
	<div class="col-md-10 col-xs-12">
		<h1 class="col-xs-12 text-center huge neon-sign bubble">Frequently Asked Questions</h1>
		<span class="col-xs-12 bubble">
			...
			<div class="answer">
			A: We do not take reservations -- the seating style at SSB is first come, first serve.  If you want to organize a private party of at least 20 people, please see our home page and submit the forms there.

			The second floor is available for reserved parties, as well as the VIP room! Call or e-mail us if you are interested in hosting an event at SSB!  You can see a video of the VIP room under the NEWS tab, where all our cutting edge blog posts are located!
			</div>
			<br/><br/>
			<h2 id="catering">Catering Questions</h2>
			<div class="question">
			...
			<div class="answer">
			A: Yes we cook onsite.  We bring the grill to the location you wish!  We have tents and we can perform in any weather, although if you wish to cancel for concern for your guests, please notify us as soon as you know of your decision at statestreetbrats@yahoo.com
			</div>
			<div class="question">
			...
			<div class="question">
			Q: Do you do "CUP NIGHTS" for IN HOUSE CATERING EVENTS?
			</div>
			<div class="answer">
