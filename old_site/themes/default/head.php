<div id="theme-holder">
	<div id="theme-top">
		...
		<div id="theme-tunes">
			<object data="/scripts/dewplayer/dewplayer-mini.swf" width="160" height="20" id="dewplayer" name="dewplayer" type="application/x-shockwave-flash" width="240"><param name="movie" value="/scripts/dewplayer/dewplayer-playlist.swf" /><param name="flashvars" value="mp3=/audio/PharrellHappy.mp3&amp;autostart=1" /></object>
		</div>
		<img id="theme-top-tr" src="/themes/default/frame-tr.png" alt="" />
	</div>
    <!--Thumb Friendly Mobile Redirect Script-->
<!--
<script src="http://static.mobilewebsiteserver.com/redirect.js" type="text/javascript"></script>
<script type="text/javascript">Mobile_redirect("http://m.statestreetbrats.com");</script>
-->
	<div id="theme-head">
...
// Load open hours
global $db;
$temp = $db->select('pages', 'Content, UNIX_TIMESTAMP(DateModified) AS `DateModified`', "WHERE `PageID`='18'");
$hrs = $db->getRow($temp);
// Display specials
echo '<div id="open-hours">' . $hrs['Content'] . '</div>';
?>
